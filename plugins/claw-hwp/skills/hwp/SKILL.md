...
| `.hwp` | **`create.js`** (raw-patch via `cell-patch.js`) | set_cell_text · set_cell_background · set_cell_border · set_cell_diagonal · set_cell_property · set_numbered_list · set_bullet_list · replace_text · append_paragraph/heading/table/list/break · setup_document · apply_text_style · apply_paragraph_style |
